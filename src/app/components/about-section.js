    ...
    return (
        <div className="w-full relative bg-about-bg bg-cover bg-no-repeat z-0">
            <div className="w-fit grid grid-cols-[350px_350px_435px] text-white grid-rows-2 gap-x-5 gap-y-2 mx-auto pt-20 pb-5">
                <div className="w-[350px] h-[285px] p-7 bg-card1-bg bg-center bg-no-repeat flex flex-col justify-between">
                ...
                <div className="w-[350px] h-[285px] p-7 bg-card4-bg bg-center bg-no-repeat flex flex-col justify-between">
                    <div className="space-y-3">
                        <h3 className="text-lg font-medium leading-3">
                            Leadership
                        </h3>
                ...
                <div className="w-[435px] row-span-2 bg-long-card-bg bg-center bg-no-repeat">
                ...
                <div className="w-[350px] h-[285px] p-7 bg-card2-bg bg-center bg-no-repeat flex flex-col justify-between">
                    <div className="space-y-3">
                        <h3 className="text-lg font-medium leading-3">
                            What is Jamiat?
                        </h3>
                ...
                <div className="w-[350px] h-[285px] p-7 bg-card3-bg bg-center bg-no-repeat flex flex-col justify-between">
                    <div className="space-y-3">
                        <h3 className="text-lg font-medium leading-3">Blogs</h3>
                        <div className="h-px w-full bg-white"></div>
                        <p className="text-sm font-light">
                            Vivamus suscipit tortor eget felis porttitor
                        </p>
