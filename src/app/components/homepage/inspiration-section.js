...
export default function Inspiration() {
    ...
    return (
        <div
            ...
            className="w-full md:h-[48vw] relative bg-cover bg-inspiration-bg text-white flex md:flex-row flex-col items-center"
        >
            {swiperLoaded && (
                <Swiper
                    loop={true}
                ...
                >
                    {inspirations.map((inspiration) => (
                        <SwiperSlide
                            key={inspiration._id}
                            className="w-full h-full !flex pb-10 justify-center flex-col my-10 md:my-0 gap-y-1 lg:gap-y-4 pl-2 mobile:pl-[10vw]"
                        >
